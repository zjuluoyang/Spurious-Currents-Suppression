...
//add
//replace the original alpha field with smoothed alpha field
    volScalarField alpha1_smooth = alpha1_;
Info << "Smoothing alpha1 field in interfaceProperties.C" << endl;
